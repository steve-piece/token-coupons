...
export function helpText () {
  return [
    ...
    'which skills have never been used, and one recommendation per skill. Nothing is changed. Codex, Cursor and Gemini CLI',
    'are read too when they are on the machine: their skills are rows, their chats count as uses, and the report says',
    'which of their chats it could and could not open.',
